...
import { SignInModalProps, PresetResource } from "./SignInModal.types";
 ...
 */
const BlockinUIDisplay: React.FC<SignInModalProps> = ({
    challengeParams,
    address,
    displayedResources = [],
                ...
                <div className='blockin-root'>
                    <div className="blockin-popup-container" style={modalStyle}>
                        <div className="blockin-popup" style={modalStyle}>
                            {displayNotConnnectedWarning && <><b>Warning: Your wallet is not currently connected. You will not be able to sign the challenge message.  </b><hr /></>}
                            ...
                            <div className='blockin-header'>
                                ...
                                <div className="header-end">
                                    {/* Close Button */}
                                    <button className='blockin-closebutton' onClick={() => {
                                        setDisplayMessage('');
                                        setSelectedResources(getDefaultSelectedResources(displayedResources));
                            ...
                            <div className='blockin-challenge'>
                                ...
                                {challengeParamsAreValid ? <>
                                    <div className='blockin-challenge-details'>
                                        ...
                                        <p><b>
                                            <Link url={challengeParams.domain} /> wants you to sign in with your {chain.name} account: {<Link text={challengeParams.address} url={chain.getAddressExplorerUrl ? chain.getAddressExplorerUrl(challengeParams.address) : ''} />}
                                        </b></p>
                            ...
                            < div className='blockin-custom-add-resources' >
                                {(canAddCustomAssets || canAddCustomUris) &&
                                    <>
                                        ...
                                        {<p>This site is allowing you to add your own custom resources to this sign-in attempt below. </p>}
                            ...
                            < div className='blockin-sign-challenge-button' >
                                ...
                                <p>Once you click the button below, this site will send a signature request to your {chain.name} wallet.</p>
